...
public class SelectionSort extends JPanel {
	...
	private SelectionSortSimulation selectionSortSimulation;
	
	public SelectionSort(JPanel mainPanel) {
		this.mainPanel = mainPanel;	
		setBackground(BACKGROUND_COLOR);
		setBorder(BorderFactory.createEmptyBorder(BORDER_SIZE, BORDER_SIZE, BORDER_SIZE, BORDER_SIZE));
		setLayout(new BorderLayout(BORDER_SIZE, BORDER_SIZE));
		
		selectionSortSimulation = new SelectionSortSimulation(5);
	...
	private void initialize_All() {
		...
		///Top Menu Label
		lblTitle = new JLabel("\"Selection Sort\"", SwingConstants.CENTER);
			...
			public void actionPerformed(ActionEvent arg0) {
				{
					if (txtInput1.getText().equals("") || txtInput2.getText().equals("") || txtInput3.getText().equals("") || txtInput4.getText().equals("") || txtInput5.getText().equals("") || txtTime.getText().equals("")) {
						...
						if(Integer.valueOf(txtTime.getText()) ==0){
							...
							if (!selectionSortSimulation.getThreadState()) {
								selectionSortSimulation.setTime(Integer.valueOf(txtTime.getText()));
								if (btnAscending.isSelected()) {
									selectionSortSimulation.setOrder("Asc");
								}else {
									selectionSortSimulation.setOrder("Dsc");
								}
								selectionSortSimulation.setArrayValue(Integer.valueOf(txtInput1.getText()), Integer.valueOf(txtInput2.getText()), Integer.valueOf(txtInput3.getText()), Integer.valueOf(txtInput4.getText()), Integer.valueOf(txtInput5.getText()));
							}
							
							selectionSortSimulation.start();
						}
					}
				}
			}
		...
		drawPanel.add(selectionSortSimulation, BorderLayout.CENTER); 
